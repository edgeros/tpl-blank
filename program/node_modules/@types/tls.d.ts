declare module "tls" {
     ...
     */
    export function createServer(opt : object, sockaddr : SockAddr, backlog : number) : Tls;
     ...
     */
    export function createClient(opt : object, sockaddr : SockAddr, timeout : number) : Tls;
     ...
     */
    export function createClient(sockaddr : SockAddr,  callback: Function) : Tls;
     ...
     */
    export function createByFd(name : string, sockFd : number, timeout?: number) : Tls;
     ...
     *                  tls {Object} Tls object.
     */
    export function createByFd(name : string, sockFd : number, callback: Function) : Tls;

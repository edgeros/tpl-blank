declare module "fs" {	
     ...
     */
    export function open(path : string, flags?: number, mode?: number) : boolean;
     ...
     */
    export function readFile(path : string, encode : string) : Buffer;
    ...
    /**
     * This function traverses all subdirectories and calculates the sum of all file sizes in the directory.
     * 
     ...
     * @param ...arg {Any} Callback arguments. default: undefined.
     */
    export function dirWalk(path : string, func : Function, ...arg : any);
     ...
     */
    export function readlink(volume : string) : boolean;

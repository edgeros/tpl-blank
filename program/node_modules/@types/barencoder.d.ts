declare module "barencoder" {	
     ...
     */
    export function defaultOpt(width : number, height : number, margin : number, eccLevel : number) : object;
     ...
     */
    export function encode(text?: string, format?: string , path?: string, opt?:object) : boolean;

declare module "http" {
    ...
    namespace http {
        ...
        export function request(url: string, callback: (res: HttpClientResponse) => void): HttpClient;
        export function request(url: string, callback: (res: HttpClientResponse) => void, options?: HttpClientRequestOptions, tlsOpt?: object): HttpClient;
        export function get(url: string, callback: (res: HttpClientResponse) => void, options?: HttpClientRequestOptions, tlsOpt?: object);
        ...
        namespace HttpServer {
            ...
            export function createServer(group: string, handle: Function, subs: number, subMode?: string): http.HttpServer;
            export function createServer(group: string, handle: Function, subs: number, subMode?: string, saddr?: object): http.HttpServer;
            export function createServer(group: string, handle: Function, subs: number, subMode?: string, saddr?: object, tlsOpt?: object): http.HttpServer;

            export function createSubServer(group: string, handle: Function): http.HttpServer;
            ...
            export class HttpServerRequest extends HttpInput {
                constructor()
            ...
            export class HttpServerResponse extends HttpOutput {
                constructor()
                method: string;
                path: string;
                statusCode: number;

declare module "iosched" {	
     ...
     * 
     * @param amethod {Integer} Event listening method.
     * @param afd {Integer} File descriptor.
     * @param acallback {Function} Callback function when event occurs.
     *                    arg {Any} Argument.
     *                    ioevent {Object} This IoEvent object.
     * @param aerrback {Function} Callback function when callback return false.
     *                    arg {Any} Argument.
     *                    ioevent {Object} This IoEvent object.
     * @param arg {Any} Argument, saved in this ioevent.arg property.
     */
    export function event(method : number, fd : number, callback : Function, errback?: Function, arg?: any) : object;
     ...
     * @param arg {Any} Argument, saved in this ioevent.arg property.
     */
    export function event(method : number, fd : number, callback : Function, arg?: any) : object;
     ...
     */
    export function add(ioevent : object) : void;
     ...
     * @param ioevent {Object} IoEvent object.
     */
    export function once(ioevent : object) : void;
     ...
     */
    export function remove(ioevent?: object) : void;
     ...
     */
    export function fds(fdsUser?: Array<number>) : Array<number>;
     ...
     */
    export function select(fdsUser?: object, timeout : number) : Array<number>;
     ...
     * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function poll(timeout : number) : Array<number>;

    export function poll() : Array<number>;
     ...
     * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function forever(check?: object, timeout : number) : Array<number>;

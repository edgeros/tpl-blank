declare module "socket.io" {
    ...
    class Server {
         ...
         */
        constructor(server : object, options : object);
         ...
         * @param value {Boolean} default: true.
         */
        origins(value : string | string[]) : any;
         ...
         */
        onconnection(socket : object) : Server;
    ...
    class Namespace {
         ...
         * @param callback {Function}
         */
        clients(callback : Function) : void;
    ...
    class Socket {
         ...
         * @param callback {Function}
         */
        join(eventName : string, callback : Function) : Socket;
         ...
         * @param callback {Function}
         */
        join(eventName : Array<string>, callback : Function) : Socket;
         ...
         * @param callback {Function}
         */
        leave(eventName : string, callback : Function) : Socket;

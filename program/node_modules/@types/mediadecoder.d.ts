...
declare module "mediadecoder" {
	...
	interface PreviewVideoFormat extends IRemuxFormat {
	...
	interface AudioFormat extends IRemuxFormat {
		disable?: boolean;// {Boolean} Does disable preview?
	...
	interface VideoFormat extends IRemuxFormat {
		disable?: boolean;
	...
	class MediaDecoder {
		...
		remuxFormat(fmt: IRemuxFormat): boolean

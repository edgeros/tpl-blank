declare module "leveldb" {
     ...
     */
    export function defaultOpt(flags: string): LevelDBOptions;
     ...
     */
    export function open(dbPath: string, opt?: object): Db;
     ...
     * @param opt {Object} LevelDB option object. default: leveldb.defaultOpt('c+').
     */
    export function repair(dbPath: string, opt?: object): boolean;
     ...
     * @param dbPath {String} Database path.
     */
    export function destroy(dbPath: string): boolean;

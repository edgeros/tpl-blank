declare module "pipe" {
    ...
    class Netif {
         ...
         */
        read(buffer : Buffer, offset?: number, length?: number, timout?: number) : number;
         ...
         * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
         */
        write(string : string, timout?: number) : number;
         ...
         * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
         */
        write(buffer : Buffer, offset?: number, length?: number, timout?: number) : number;

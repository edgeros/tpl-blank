declare module "message" {	
     ...
     */
    export function send(pid : number, msg : string, timeout?: number) : number;
     ...
     * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function send(service : number, msg : string, timeout?: number) : number;
     ...
     * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function recv(info : InfoObj, timeout?: number) : number;

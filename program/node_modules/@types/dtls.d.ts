declare module "dtls" {	
     ...
     */
    export function createServer(opt : object, sockaddr : object) : object;
     ...
     */
    export function createClient(opt : object, sockaddr : object, timeout : number) : object;
     ...
     */
    export function createClient(sockaddr : object, callback : Function) : object;
     ...
     */
    export function createByFd(name : string, sockFd : number, timeout : number) : object;
     ...
     * @param num {Integer} CAN packet frame number. default: 1.
     */
    export function createByFd(name : string, sockFd : number, callback : Function) : object;

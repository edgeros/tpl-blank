declare module "mutex" {
    ...
    class Mutex {
         ...
         * 
         * @param tname {String} Mutex name.
         * @param tprioQueue {Boolean} Priority waiting queue.
         */
        constructor(name : string, prioQueue : boolean);
         ...
         * 
         * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever until mutex.lock() is successful.
         */

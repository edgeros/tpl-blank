declare module "tcp" {
     ...
     */
    export function createServer(sockaddr : SockAddr, backlog : number) : Tcp;
     ...
     */
    export function createClient(sockaddr : SockAddr, timeout : number) : Tcp;
     ...
     */
    export function createClient(sockaddr : SockAddr, callback : Function) : Tcp;
     ...
     */
    export function createByFd(sockFd : number) : Tcp;

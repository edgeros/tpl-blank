declare module "inetaddr" {	
     ...
     * @param addr {String} Address string.
     */
    export function addrValid(addr : string) : boolean;
     ...
     * @param addr {String} Address string.
     */
    export function maskValid(addr : string) : boolean;
     ...
     */
    export function toPrefix(netmask : string) : number;
     ...
     */
    export function fromPrefix(prefix : number, isIPv6?: boolean) : string;

declare module "socket" {	
     ...
     */
    export function socket(domain : number, type : number) : number;
    export function sockaddr(domain : string, type : number);
     ...
     */
    export function close(sockFd : numberr) : void;
     ...
     */
    export function bind(sockFd : number, sockaddr : SockAddr) : boolean;
     ...
     */
    export function listen(sockFd : number, backlog?: number) : boolean;
     ...
     */
    export function accept(sockFd : number, remoteAddr?: SockAddr, timeout?: number) : number;
     ...
     */
    export function connect(sockFd : number, remoteAddr?: SockAddr, timeout?: number) : boolean;
     ...
     */
    export function send(sockFd : number, string : string, timeout?: number) : number;
     ...
     * @param {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function send(sockFd : number, buffer : Buffer, offset?: number, length?: number, timeout?: number) : number;
     ...
     * @param {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function sendto(sockFd : number, remoteAddr : SockAddr, string : string, timeout?: number) : number;
     ...
     * @param {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function sendto(sockFd : number, remoteAddr : SockAddr, buffer : Buffer, offset?: number, length?: number, timeout?: number) : number;
     ...
     * @param {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function recv(sockFd : number, buffer : Buffer, offset?: number, length?: number, timeout?: number) : number;
     ...
     * @param {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
     */
    export function recvfrom(sockFd : number, remoteAddr : SockAddr, buffer : Buffer, offset?: number, length?: number, timeout?: number) : number;
     ...
     */
    export function shutdown(sockFd : number, how?: string) : boolean;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function error(sockFd : number) : number;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function isListen(sockFd : number) : boolean;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function sockName(sockFd : number) : SockAddr;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function peerName(sockFd : number) : SockAddr;
     ...
     */
    export function bindToDevice(sockFd : number, ifname?: string) : boolean;
     ...
     */
    export function setKeepAlive(enable : boolean, idle?: number, interval?: number, count?: number) : boolean;
     ...
     */
    export function setNoDelay(sockFd : number, enable : boolean) : boolean;
     ...
     */
    export function setNoDelay(sockFd : number, linger : SockLinger) : boolean;
     ...
     */
    export function setTTS(sockFd : number, timeToLive : number) : boolean;
     ...
     */
    export function setBroadcast(sockFd : number, enable : boolean) : boolean;
     ...
     */
    export function setReuseAddr(sockFd : number, enable : boolean) : boolean;
     ...
     */
    export function setIPv6Only(sockFd : number, enable : boolean) : boolean;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function setIPv6Only(sockFd : number) : number;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function getRecvBufferSize(sockFd : number) : number;
     ...
     * @param sockFd {Integer} Socket file descriptor.
     */
    export function getSendBufferSize(sockFd : number) : number;
     ...
     */
    export function setRecvBufferSize(sockFd : number, size : number) : boolean;
     ...
     * @param size {Integer} Receive buffer size. Must be between 1024bytes and 16Mbytes.
     */
    export function setSendBufferSize(sockFd : number, size : number) : boolean;
     ...
     */
    export function addMembership(sockFd : number, multicastAddr : string, multicastInterface?: string, sourceAddr?: string) : boolean;
     ...
     * @param sourceAddr {String} Only receive multicast packets sent by the specified source address. default: all packets.
     */
    export function dropMembership(sockFd : number, multicastAddr : string, multicastInterface?: string, sourceAddr?: string) : boolean;
     ...
     * @param multicastInterface {String} Multicast network interface name. default: all interface.
     */
    export function dropMembership(sockFd : number, multicastInterface : string) : boolean;
     ...
     * @param timeToLive {Integer} IP TTL: 0 ~ 255.
     */
    export function dropMembership(sockFd : number, timeToLive : number) : boolean;
     ...
     */
    export function setMulticastLoop(sockFd : number, enable : boolean) : boolean;
}
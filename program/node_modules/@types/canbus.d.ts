declare module "canbus" {	
     ...
     */
    export function open(devNo : number) : object;
     ...
     */
    export function canFrame(num?: string) : object;
     ...
     */
    export function canFdFrame(num?: string) : object;
    ...
    class Canbus {
         ...
         * 
         * @param frameArray {Array} Save the received packet to this frame object array.
         * @param timeout {Integer} Read timeout in milliseconds. default: undefined means wait forever.
         */
        read(frameArray : Array<object>, timeout?: number) : number;
         ...
         * @param count {Integer} The maximum number of packets we want to be send. default: frameArray.length.
         * @param timeout {Integer} Write timeout in milliseconds. default: undefined means wait forever.
         */

declare module "util" {	
    ...
    export function inherits(obj1:object, obj2:object);
     ...
     */
    export function inspect(obj : any, showHidden : boolean, depth?: number) : boolean;
     ...
     */
    export function clone(obj : object) : boolean;
     ...
     * @param ...args 
     */
    export function log(string : string, ...args : any) : void;
     ...
     * @param ...args 
     */
    export function logToString(string : string, ...args : any) : string;

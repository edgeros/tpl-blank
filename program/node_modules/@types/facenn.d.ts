...
declare module "facenn" {
	...
	export interface IFacennAttribute {
		width: number; // {Integer} Video width.
		height: number; // {Integer} Video height.
		pixelFormat: number; // {Integer} Pixel format.
	}

	export const PIX_FMT_RGB24: number;  //	RGB24 pixel format.
	export const PIX_FMT_BGR2RGB24: number;  //	BGR24 to RBG24 pixel format.
	export const PIX_FMT_GRAY2RGB24: number;  //	Grayscale to RGB24 pixel format.
	export const PIX_FMT_RGBA2RGB24: number;  //	RGBA to RGB24 pixel format.
	...
	export function detect(videoBuf: Buffer, attribute: IFacennAttribute, quick?: boolean): Array<FaceInfo>
	export function feature(videoBuf: Buffer, attribute: IFacennAttribute, faceInfo: FaceInfo, extra?: boolean): FaceKey
	export function compare(faceKey1: FaceKey, faceKey2: FaceKey): number

declare module "bardecoder" {	
     ...
     */
    export function defaultOpt(fast?: boolean, rotate?: boolean, format?: string) : object;
     ...
     */
    export function decode(path?: string, opt?: any) : object;
     ...
     * @param opt {Object} Bar code decode option object. default: bardecoder.defaultOpt(false, false).
     */
    export function decode(buffer : Buffer, subImageAttr : any, opt?: any) : object;

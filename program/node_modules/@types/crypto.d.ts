declare module "crypto" {	
     ...
     */
    export function getHashes() : Array<object>;
     ...
     */
    export function createHash(hashtype : string, hmackey?: string) : Hash;
     ...
     * @param hmackey {String} | {Buffer} Specify HMAC key if HMAC encoding is used. default: undefined, do not use hmac.
     */
    export function createVerify(hashType : string, hmackey?: string) : verify;
     ...
     */
    export function createAescrypto(key : string, keyBits : number) : AES;
}
